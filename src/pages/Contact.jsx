import Page_Title from "../components/Title/Title";
          ...
          <div className="flex lg:flex-row flex-col  gap-8 mt-10 ">
            <div className="bg-white shadow-lg p-10">
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <span className=" flex justify-center items-center w-10 h-10 rounded-full text-white bg-lightRed">
                    <LuPhone />
                  </span>
            ...
            <div className="flex-1 bg-white shadow-lg p-10">
              <form action="">
                ...
                <textarea
                  className="mt-4 bg-gray-100 p-3 w-full outline-none"
                  rows={8}
