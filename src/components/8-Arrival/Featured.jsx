  ...
  return (
    <div className="mt-8 grid lg:grid-cols-4 mg:grid-cols-2 grid-cols-1 gap-8">
        ...
        <figure className="bg-black relative lg:row-span-2 md:row-span-1 lg:col-span-2 md:col-span-1 ">
          <img className="w-full h-full object-contain" src="images/play.png" alt="" />
        ...
        <figure className="bg-black relative lg:col-span-2">
          <img className="w-full h-full" src="images/woman.webp" alt="image" loading="lazy" />
          <div className="absolute bottom-4 left-8 text-white ">
        ...
        <figure className="bg-black relative col-span-1">
          <img className="w-full h-full object-contain" src="images/speaker.png" alt="image" loading="lazy" />
          <div className="absolute bottom-4 left-8 text-white ">
        ...
        <figure className="bg-black relative col-span-1">
          <img className="w-full h-full object-contain" src="images/perfum.png" alt="image" loading="lazy" />
          <div className="absolute bottom-4 left-8 text-white ">
